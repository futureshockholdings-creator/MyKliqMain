...
export async function seedEducationalPosts() {
  ...
  const posts = [
    ...
    },
    {
      ...
      content: 'Link your YouTube, Discord, Bluesky, and other social accounts to earn Kliq Koins! Get 1,000 Koins per platform (up to 10 platforms). Share content across your networks effortlessly.',
