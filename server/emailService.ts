    ...
    const htmlContent = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="margin: 20px 0;">
          <div style="background-color: #e0f2fe; padding: 15px; border-radius: 8px; border-left: 4px solid #0284c7; margin-bottom: 15px;">
            <h3 style="color: #0284c7; margin: 0 0 10px 0;">User Question:</h3>
            <p style="margin: 0; white-space: pre-wrap;">${conversation.userQuestion}</p>
          </div>
          
          <div style="background-color: #f0f9ff; padding: 15px; border-radius: 8px; border-left: 4px solid #4f46e5;">
            <h3 style="color: #4f46e5; margin: 0 0 10px 0;">Bot Response:</h3>
            <p style="margin: 0; white-space: pre-wrap;">${conversation.botResponse}</p>
          </div>
        </div>
