...
- **Unique One-Time Invite Codes**: Completely revamped invite code system with randomly generated 12-digit numeric codes, one-time usage tracking through dedicated used_invite_codes table, automatic code invalidation after use, and prevention of duplicate usage ensuring each invite code can only create one friendship connection (August 16, 2025)
