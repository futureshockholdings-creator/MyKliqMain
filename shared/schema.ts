...
export const actions = pgTable("actions", {
  ...
  thumbnailUrl: varchar("thumbnail_url"),
  recordingUrl: varchar("recording_url"), // URL to the recorded video for playback after stream ends
  recordingDuration: integer("recording_duration"), // Duration in seconds of the recording
...
export const notificationTypeEnum = pgEnum("notification_type", [
  ...
  "story_view", "live_stream", "meetup_invite", "birthday", "incognito_message", "system"
]);
